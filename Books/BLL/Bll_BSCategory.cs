...
namespace Books.BLL
{
    ...
    /// BSCategory业务逻辑对象
    /// </summary>
    public partial class Bll_BSCategory
    {
        /// <summary>
        /// BSCategory数据访问对象
        /// </summary>
        private readonly Dal_BSCategory _bSCategoryDal = new Dal_BSCategory();
        /// <summary>
        /// 实例化BSCategory业务逻辑对象
        /// </summary>
        public Bll_BSCategory()
        {
            
        }
        public DataTable GetDataTable(string sql,params SqlParameter[] pms)
        {
            return DBHelper.ExecuteDataTable(sql,pms);
        }
        /// <summary>
        ...
        public List<Mod_BSCategory> GetAllModel()
        {
            ...
            return this._bSCategoryDal.GetAllModel();
        }
        /// <summary>
        ...
        public bool Add(Mod_BSCategory bSCategoryMod)
        {
            ...
            return this._bSCategoryDal.Add(bSCategoryMod);
        }
        /// <summary>
        ...
        {
            //调用数据访问层查询方法并将查询结果返回
            return this._bSCategoryDal.GetModel(bSID);
        }
        /// <summary>
        /// 根据主键删除一条记录
        /// </summary>
        ...
        public bool Delete(int bSID)
        {
            ...
            return this._bSCategoryDal.Delete(bSID);
        }
        /// <summary>
        /// 判断是否有此主键对应的记录
        /// </summary>
        ...
        public bool Exists(int bSID)
        {
            ...
            return this._bSCategoryDal.Exists(bSID);
        }
        /// <summary>
        /// 更新数据
        /// </summary>
        ...
        public bool Update(Mod_BSCategory bSCategoryMod)
        {
            ...
            return this._bSCategoryDal.Update(bSCategoryMod);
        }
        /// <summary>
        /// 判断是否有此记录
        /// </summary>
        ...
        public bool Exists(Mod_BSCategory bSCategoryMod)
        {
            ...
            return this._bSCategoryDal.Exists(bSCategoryMod);
        }
        /// <summary>
        ...
        {
            //调用数据访问层方法
            return this._bSCategoryDal.Exists(where, sqlParameters);
        }
        /// <summary>
        /// 自定义删除
        /// </summary>
        ...
        public bool Delete(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._bSCategoryDal.Delete(where, sqlParameters);
        }
        /// <summary>
        /// 自定义查找
        /// </summary>
        ...
        public List<Mod_BSCategory> GetModelList(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._bSCategoryDal.GetModelList(where,sqlParameters);
        }
        /// <summary>
        /// 自定义查询出匹配记录有多少条
        /// </summary>
        ...
        public int GetCount(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._bSCategoryDal.GetCount(where,sqlParameters);
        }
        /// <summary>
        /// 分页获取数据
        /// </summary>
        ...
        public List<Mod_BSCategory> GetListByPage(string where, string orderby, bool isDesc, int startIndex, int endIndex, params SqlParameter[] sqlParameters)
        {
            ...
            return this._bSCategoryDal.GetListByPage(where,orderby,isDesc,startIndex,endIndex,sqlParameters);
        }
        /// <summary>
        /// 分页获取数据并返回总记录条数
        /// </summary>
        ...
        {
            //调用数据访问层分页获取数据方法
            return this._bSCategoryDal.GetMinutePage(where, orderby, isDesc, pageIndex, pageItemCount, sqlParameters);
        }
        /// <summary>
        /// 分页获取数据并返回总记录条数
        /// </summary>
        ...
        {
            //调用数据访问层分页获取数据方法
            return this._bSCategoryDal.GetMinutePage(where, orderby, isDesc, pageIndex, pageItemCount, out allItmeCount, sqlParameters);
        }
    }
}
