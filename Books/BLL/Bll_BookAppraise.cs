...
namespace Books.BLL
{
    ...
    /// BookAppraise业务逻辑对象
    /// </summary>
    public partial class Bll_BookAppraise
    {
        /// <summary>
        /// BookAppraise数据访问对象
        /// </summary>
        private readonly Dal_BookAppraise _bookAppraiseDal = new Dal_BookAppraise();
        /// <summary>
        /// 实例化BookAppraise业务逻辑对象
        /// </summary>
        public Bll_BookAppraise()
        {
        ...
        public List<Mod_BookAppraise> GetAllModel()
        {
            ...
            return this._bookAppraiseDal.GetAllModel();
        }
        /// <summary>
        ...
        public bool Add(Mod_BookAppraise bookAppraiseMod)
        {
            ...
            return this._bookAppraiseDal.Add(bookAppraiseMod);
        }
        /// <summary>
        ...
        {
            //调用数据访问层查询方法并将查询结果返回
            return this._bookAppraiseDal.GetModel(bAID);
        }
        /// <summary>
        /// 根据主键删除一条记录
        /// </summary>
        ...
        public bool Delete(int bAID)
        {
            ...
            return this._bookAppraiseDal.Delete(bAID);
        }
        /// <summary>
        /// 判断是否有此主键对应的记录
        /// </summary>
        ...
        public bool Exists(int bAID)
        {
            ...
            return this._bookAppraiseDal.Exists(bAID);
        }
        /// <summary>
        /// 更新数据
        /// </summary>
        ...
        public bool Update(Mod_BookAppraise bookAppraiseMod)
        {
            ...
            return this._bookAppraiseDal.Update(bookAppraiseMod);
        }
        /// <summary>
        /// 判断是否有此记录
        /// </summary>
        ...
        public bool Exists(Mod_BookAppraise bookAppraiseMod)
        {
            ...
            return this._bookAppraiseDal.Exists(bookAppraiseMod);
        }
        /// <summary>
        ...
        {
            //调用数据访问层方法
            return this._bookAppraiseDal.Exists(where, sqlParameters);
        }
        /// <summary>
        /// 自定义删除
        /// </summary>
        ...
        public bool Delete(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._bookAppraiseDal.Delete(where, sqlParameters);
        }
        /// <summary>
        /// 自定义sql查找
        /// </summary>
        ...
        public List<View_BookAppraise> GetModelListBySqlStr(string where)
        {
            ...
            return this._bookAppraiseDal.GetModelListBySqlStr(where);
        }
        /// <summary>
        /// 自定义查找
        /// </summary>
        ...
        {
            //调用数据访问层的自定义查找方法并将查找结果返回
            return this._bookAppraiseDal.GetModelList(where,sqlParameters);
        }
        /// <summary>
        /// 自定义查询出匹配记录有多少条
        /// </summary>
        ...
        public int GetCount(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._bookAppraiseDal.GetCount(where,sqlParameters);
        }
        /// <summary>
        /// 分页获取数据
        /// </summary>
        ...
        public List<Mod_BookAppraise> GetListByPage(string where, string orderby, bool isDesc, int startIndex, int endIndex, params SqlParameter[] sqlParameters)
        {
            ...
            return this._bookAppraiseDal.GetListByPage(where,orderby,isDesc,startIndex,endIndex,sqlParameters);
        }
        /// <summary>
        /// 分页获取数据并返回总记录条数
        /// </summary>
        ...
        {
            //调用数据访问层分页获取数据方法
            return this._bookAppraiseDal.GetMinutePage(where, orderby, isDesc, pageIndex, pageItemCount, sqlParameters);
        }
        /// <summary>
        /// 分页获取数据并返回总记录条数
        /// </summary>
        ...
        {
            //调用数据访问层分页获取数据方法
            return this._bookAppraiseDal.GetMinutePage(where, orderby, isDesc, pageIndex, pageItemCount, out allItmeCount, sqlParameters);
        }
    }
}
