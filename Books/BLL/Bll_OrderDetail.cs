...
namespace Books.BLL
{
    ...
    public partial class Bll_OrderDetail
    {
        ...
        /// OrderDetail数据访问对象
        /// </summary>
        private readonly Dal_OrderDetail _orderDetailDal = new Dal_OrderDetail();
        /// <summary>
        /// 实例化OrderDetail业务逻辑对象
        /// </summary>
        ...
        {
            return this._orderDetailDal.GetView_OrderDetails(OrderID);
        }
        /// <summary>
        /// 获取订单详情书籍表
        /// </summary>
        ...
        {
            return this._orderDetailDal.GetView_ODBooks(OrderID);
        }
        /// <summary>
        ...
        public List<Mod_OrderDetail> GetAllModel()
        {
            ...
            return this._orderDetailDal.GetAllModel();
        }
        /// <summary>
        ...
        public bool Add(Mod_OrderDetail orderDetailMod)
        {
            ...
            return this._orderDetailDal.Add(orderDetailMod);
        }
        /// <summary>
        ...
        {
            //调用数据访问层查询方法并将查询结果返回
            return this._orderDetailDal.GetModel(oDID);
        }
        /// <summary>
        /// 根据主键删除一条记录
        /// </summary>
        ...
        public bool Delete(int oDID)
        {
            ...
            return this._orderDetailDal.Delete(oDID);
        }
        /// <summary>
        /// 判断是否有此主键对应的记录
        /// </summary>
        ...
        public bool Exists(int oDID)
        {
            ...
            return this._orderDetailDal.Exists(oDID);
        }
        /// <summary>
        /// 更新数据
        /// </summary>
        ...
        public bool Update(Mod_OrderDetail orderDetailMod)
        {
            ...
            return this._orderDetailDal.Update(orderDetailMod);
        }
        /// <summary>
        /// 判断是否有此记录
        /// </summary>
        ...
        public bool Exists(Mod_OrderDetail orderDetailMod)
        {
            ...
            return this._orderDetailDal.Exists(orderDetailMod);
        }
        /// <summary>
        ...
        {
            //调用数据访问层方法
            return this._orderDetailDal.Exists(where, sqlParameters);
        }
        /// <summary>
        /// 自定义删除
        /// </summary>
        ...
        public bool Delete(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._orderDetailDal.Delete(where, sqlParameters);
        }
        /// <summary>
        /// 自定义查找
        /// </summary>
        ...
        public List<Mod_OrderDetail> GetModelList(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._orderDetailDal.GetModelList(where,sqlParameters);
        }
        /// <summary>
        /// 自定义查询出匹配记录有多少条
        /// </summary>
        ...
        public int GetCount(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._orderDetailDal.GetCount(where,sqlParameters);
        }
        /// <summary>
        /// 分页获取数据
        /// </summary>
        ...
        public List<Mod_OrderDetail> GetListByPage(string where, string orderby, bool isDesc, int startIndex, int endIndex, params SqlParameter[] sqlParameters)
        {
            ...
            return this._orderDetailDal.GetListByPage(where,orderby,isDesc,startIndex,endIndex,sqlParameters);
        }
        /// <summary>
        /// 分页获取数据并返回总记录条数
        /// </summary>
        ...
        {
            //调用数据访问层分页获取数据方法
            return this._orderDetailDal.GetMinutePage(where, orderby, isDesc, pageIndex, pageItemCount, sqlParameters);
        }
        /// <summary>
        /// 分页获取数据并返回总记录条数
        /// </summary>
        ...
        {
            //调用数据访问层分页获取数据方法
            return this._orderDetailDal.GetMinutePage(where, orderby, isDesc, pageIndex, pageItemCount, out allItmeCount, sqlParameters);
        }
    }
}
