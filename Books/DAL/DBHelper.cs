...
namespace Books.DAL
{
    ...
    public static class DBHelper
    {
        ...
        private readonly static string SqlJoinString = ConfigurationManager.ConnectionStrings["ConString"].ConnectionString;
        ...
        {
            SqlConnection con = new SqlConnection(SqlJoinString);
